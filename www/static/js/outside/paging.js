	...
	$.paging = function(el, options, index) {
		...
		var _pagerButtons = {
			getFirstButton: function(text) {
				return '<button class="first moveBtn" type="button"></button>';
			},
			getLastButton: function(text) {
				return '<button class="last moveBtn" type="button"></button>';
			},
			getPrevButton: function(text) {
				return '<button class="prev moveBtn" type="button"></button>';
			},
			getNextButton: function(text) {
				return '<button class="next moveBtn" type="button"></button>';
			},
			getPagerButton: function(text) {
				return '<button type="button" class="page_' + text + ' pageNum">' + text + '</button>';
			}
		};
